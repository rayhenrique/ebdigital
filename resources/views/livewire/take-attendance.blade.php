    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-6">
        ...
        @if(!$isReadOnly)
            <button 
                ...
                class="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 transition min-h-[52px] text-base"
            >
    ...
    @if(!$isReadOnly)
        <div class="sm:hidden fixed bottom-3 inset-x-3 z-40 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200 p-3 flex items-center justify-between gap-3">
            ...
            <button 
                ...
                wire:click="save" 
                wire:loading.attr="disabled"
                class="flex items-center justify-center gap-1.5 px-4 py-2.5 bg-indigo-600 active:bg-indigo-700 text-white font-bold rounded-xl text-xs shadow-md shadow-indigo-200 min-h-[44px] transition"
            >
